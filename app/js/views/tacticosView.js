...
export function renderTacticos() {
  ...
  return `
    <section class="dashboard-section tacticos-section">
      <h2 class="text-xl font-semibold mb-4">Tácticos</h2>
      <img src="app/images/indicadores/indicador1.png" alt="Indicador de Tácticos" class="indicador-img mb-4 rounded-md shadow">
